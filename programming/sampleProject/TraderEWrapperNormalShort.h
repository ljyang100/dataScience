#ifndef TraderEWrapperNormalShort_h_
#define TraderEWrapperNormalShort_h_
#include "TwsApiL0.h"
...
// EWrappers
//----------------------------------------------------------------------------
class TraderEWrapperNormalShort:public EWrapperL0
{
...
public:
	TraderEWrapperNormalShort(AllData &a_instance)
		: a(a_instance)
	{}

	~TraderEWrapperNormalShort()
	{
	...
	void cancelExistingShortBuyOrder(int &reqId, std::string reasonToCancel);
	void cancelExistingShortSellOrder(int &reqId, std::string reasonToCancel);
